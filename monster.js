...
class Monster extends StatusEffectPredicates
{
  static SPECIES = [
    ...
    ['\u{104042}\u{104043}', 'スライム', 5, 1, 2, 1, 0.01, 0.5, "none"],            // 弱い
    ['\u{104046}\u{104047}', 'コウモリ', 7, 2, 3, 1, 0.01, 0.5, "none"],            // ふらふら
    ['\u{104048}\u{104049}', 'オオウミウシ', 7, 3, 2, 4, 0.01, 0.5, "none"],        // 体当たり
    ['\u{10404a}\u{10404b}', 'ツバメ', 5, 2, 3, 9, 0.01, 0.5, "none"],              // 速い
    ['\u{10404e}\u{10404f}', 'ワラビー', 8, 5, 4, 9, 0.01, 0.5, "none"],            // 蹴ってくる
    ['\u{104050}\u{104051}', '催眠術師', 16, 12, 6, 11, 0.33, 0.0, "reach"],        // 寝てる。眠らせる
    ['\u{104052}\u{104053}', 'ピューシャン', 9, 5, 4, 15, 0.01, 0.5, "line"],       // 矢を打つ
    ['\u{104054}\u{104055}', 'ファンガス', 17, 6, 6, 8, 0.16, 0.5, "reach"],        // 胞子で力を下げる
    ['\u{104056}\u{104057}', 'グール', 10, 7, 4, 15, 0.01, 0.5, "none"],            // 増える
    ['\u{104058}\u{104059}', '木乃伊', 16, 16, 10, 19, 0.01, 0.5, "none"],          // 回復アイテムでダメージ
    ['\u{10405a}\u{10405b}', 'ノーム', 20, 10, 0, 16,1.0, 0.5, "reach"],            // 金を盗む
    ['\u{10405c}\u{10405d}', 'ハゲタカ', 27, 25, 10, 16, 0.16, 0.5, "none"],        // クチバシが痛い
    ['\u{10405e}\u{10405f}', 'ソーサラー', 23, 15, 10, 16, 0.01, 0.5, "reach"],     // 瞬間移動の杖を振る
    ['\u{104044}\u{104045}', 'メタルヨテイチ', 3, 500, 30, 49, 1.0, 0.0, "none"],   // 回避性のレアモン
    ['\u{104060}\u{104061}', 'おめん武者', 35, 40, 15, 26, 0.16, 0.5, "none"],      // 鎧の中は空洞だ
    ['\u{104062}\u{104063}', 'アクアター', 30, 25, 0, 19, 0.01, 0.5, "reach"],      // ガッポーン。盾が錆びるぞ
    ['\u{104064}\u{104065}', 'どろぼう猫', 40, 20, 0, 17, 0.0, 0.0, "reach"],       // アイテムを盗む
    ['\u{104124}\u{104125}', '動くモアイ像', 45, 50, 18, 27, 0.33, 0.0, "none"],    // 石像のふりをしている
    ['\u{104068}\u{104069}', '四人トリオ', 60, 10, 11, 3, 0.0, 1.0, "none"],        // 4人で固まって出現する
    ['\u{10406a}\u{10406b}', '白い手', 72, 40, 7, 23, 0.0, 0.0, "reach"],           // つかまると倒すまで動けない
    ['\u{10406c}\u{10406d}', 'ゴーレム', 52, 180, 32, 27, 0.33, 0.5, "none"],       // 巨大な泥人形
    ['\u{10422c}\u{10422d}', 'ボンプキン', 70, 30, 12, 23, 0.01, 0.5, "none"],      // 爆発する
    ['\u{104070}\u{104071}', 'パペット', 36, 40, 13, 23, 0.16, 0.5, "reach"],       // レベルを下げる
    ['\u{104072}\u{104073}', 'ゆうれい', 60, 150, 17, 27, 0.0, 0.5, "none"],        // 見えない。ふらふら
    ['\u{104074}\u{104075}', 'ミミック', 50, 30, 24, 24, 0.0, 0.0, "none"],         // アイテム・階段に化ける
    ['\u{104120}\u{104121}', 'トロール', 51, 380, 51, 21, 0.16, 0.5, "none"],       // 強い
    ['\u{104076}\u{104077}', '目玉', 62, 250, 31, 27, 0.16, 0.5, "sight"],          // 混乱させてくる
    ['\u{104078}\u{104079}', '化け狸', 80, 20, 9, 14, 0.0, 0.5, "none"],            // 別のモンスターに化ける
    ['\u{10407a}\u{10407b}', '土偶', 70, 150, 17, 24, 0.0, 0.5, "reach"],           // HP、ちから最大値を下げる
    ['\u{104122}\u{104123}', 'デビルモンキー', 78, 600, 26, 25, 0.16, 0.5, "none"], // 二倍速
    ['\u{10407c}\u{10407d}', 'マルスボース', 75, 750, 51, 29, 0.16, 0.5, "none"],   // 強い
    ['\u{10407e}\u{10407f}', '竜', 100, 3000, 68, 30, 0.75, 0.5, "line"],           // テラ強い。火を吐く
  ]
